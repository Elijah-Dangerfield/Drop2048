package com.dangerfield.drop2048.features.onboarding
 ...
 * via the `drop2048://auth/confirmed` deep-link bounced back from the
 * verification email.
 *
 ...
 * cold-launch deep-link (`drop2048://auth/confirmed`) can't carry it,
