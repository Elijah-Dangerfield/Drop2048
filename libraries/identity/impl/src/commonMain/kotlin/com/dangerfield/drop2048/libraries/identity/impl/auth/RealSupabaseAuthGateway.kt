...
import com.dangerfield.drop2048.libraries.identity.impl.SupabaseClientComponent.Companion.OAUTH_REDIRECT_HOST
import com.dangerfield.drop2048.libraries.identity.impl.SupabaseClientComponent.Companion.OAUTH_REDIRECT_SCHEME
...
class RealSupabaseAuthGateway(
    ...
    override suspend fun signInWithOAuth(provider: OAuthProvider) {
        ...
        // doesn't exist yet here — it arrives later as the `drop2048://login-callback`
