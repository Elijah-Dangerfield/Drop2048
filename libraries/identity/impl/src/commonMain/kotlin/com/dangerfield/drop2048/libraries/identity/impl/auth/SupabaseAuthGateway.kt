...
interface SupabaseAuthGateway {
     ...
     * provider redirects back to `drop2048://login-callback`, which the app feeds
     ...
     * the full `drop2048://login-callback#access_token=…` URL the provider handed
     ...
     * (`drop2048://login-callback`). Lets the deep-link collector route auth
