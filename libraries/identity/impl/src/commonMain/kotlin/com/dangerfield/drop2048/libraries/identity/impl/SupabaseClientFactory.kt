package com.dangerfield.drop2048.libraries.identity.impl

import com.dangerfield.drop2048.libraries.core.Catching
import com.dangerfield.drop2048.libraries.flowroutines.DispatcherProvider
import com.dangerfield.drop2048.libraries.identity.IdentityConfig
import com.dangerfield.drop2048.libraries.identity.auth.SecureSessionStorage
import com.dangerfield.drop2048.libraries.identity.impl.auth.SecureSessionManager
import com.dangerfield.drop2048.libraries.identity.impl.auth.SessionMirror
...
interface SupabaseClientComponent {
    ...
    fun provideSupabaseClient(
        ...
        createSupabaseClient(
            ...
            install(Auth) {
                ...
                // `drop2048://login-callback`. The app's deep-link collector hands
                ...
                // extra round trip. The matching `drop2048://login-callback` URL
    ...
    companion object {
        /** Deep-link scheme for the browser OAuth return trip — `drop2048://`. */
        const val OAUTH_REDIRECT_SCHEME = "drop2048"
