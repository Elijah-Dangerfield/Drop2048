...
import com.dangerfield.drop2048.libraries.identity.auth.AppleSignInCredential
...
import com.dangerfield.drop2048.libraries.identity.auth.DeleteAccountOutcome
import com.dangerfield.drop2048.libraries.identity.auth.LinkEmailIdentityOutcome
import com.dangerfield.drop2048.libraries.identity.auth.LinkIdentityOutcome
...
import com.dangerfield.drop2048.libraries.identity.auth.ResendOutcome
import com.dangerfield.drop2048.libraries.identity.auth.SendResetOutcome
import com.dangerfield.drop2048.libraries.identity.auth.SignInOutcome
...
import com.dangerfield.drop2048.libraries.networking.AuthTokenInvalidator
import com.dangerfield.drop2048.libraries.networking.SessionRejectionBus
...
class SupabaseAuthRepositoryImpl(
     ...
     * later as the `drop2048://login-callback` deep link, which the app feeds to
    ...
    override suspend fun linkOAuthIdentity(provider: OAuthProvider): LinkIdentityOutcome {
        ...
        // claim isn't done until the drop2048://login-callback redirect returns and
    ...
    /**
     * The browser OAuth round trip landed back on `drop2048://login-callback`. Finish
    ...
    override suspend fun completeOAuthRedirect(url: String): SignInOutcome =
        mutex.withLock {
            ...
            if (pending == null) {
                ...
                // (drop2048://login-callback#access_token=…) is the only carrier of a
    ...
    /**
     * Finish a `drop2048://login-callback` redirect that arrived with no parked
