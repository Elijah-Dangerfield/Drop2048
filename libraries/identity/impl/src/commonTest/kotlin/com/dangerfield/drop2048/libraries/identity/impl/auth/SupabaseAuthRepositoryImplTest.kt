package com.dangerfield.drop2048.libraries.identity.impl.auth
...
import com.dangerfield.drop2048.libraries.drop2048.UserScopedDataReset
...
import com.dangerfield.drop2048.libraries.identity.auth.AuthState
import com.dangerfield.drop2048.libraries.identity.auth.LinkEmailIdentityOutcome
import com.dangerfield.drop2048.libraries.identity.auth.OAuthProvider
import com.dangerfield.drop2048.libraries.identity.auth.RefreshOutcome
import com.dangerfield.drop2048.libraries.identity.auth.SignUpOutcome
import com.dangerfield.drop2048.libraries.identity.impl.MeDto
import com.dangerfield.drop2048.libraries.identity.impl.PatchMeRequest
import com.dangerfield.drop2048.libraries.identity.impl.ProfileApi
...
class SupabaseAuthRepositoryImplTest : CoroutineTest() {
    ...
    fun createGuestSession_signsInAnonymously_andEmitsAuthenticated() = runUnitTest {
        ...
        assertIs<com.dangerfield.drop2048.libraries.identity.auth.SignInOutcome.Success>(outcome)
        val state = assertIs<AuthState.Authenticated>(repo.current())
    ...
    fun createGuestSession_whenAnonSignInThrows_returnsFailureOutcome_andStaysUnauthenticated() = runUnitTest {
        ...
        val outcome = repo.createGuestSession()
        assertIs<com.dangerfield.drop2048.libraries.identity.auth.SignInOutcome.Unknown>(outcome)
        assertIs<AuthState.Unauthenticated>(repo.current())
    }
    ...
    fun accountSwitch_dumpsDepartingUser_beforeEmit_andAnnouncesUserChange() = runUnitTest {
        ...
        runCurrent()
        repo.completeOAuthRedirect("drop2048://login-callback#access_token=t")
        assertIs<com.dangerfield.drop2048.libraries.identity.auth.SignInOutcome.Success>(signIn.await())
    ...
    fun accountClaim_sameUserId_doesNotDump_andAnnouncesNothing() = runUnitTest {
        ...
        runCurrent()
        repo.completeOAuthRedirect("drop2048://login-callback")
        assertIs<com.dangerfield.drop2048.libraries.identity.auth.LinkIdentityOutcome.Success>(link.await())
    ...
    fun linkOAuthIdentity_suspendsUntilRedirect_doesNotReturnSuccessWhileAnonymous() = runUnitTest {
        ...
        // anonymous) until the drop2048://login-callback redirect actually lands.
        val gateway = FakeSupabaseAuthGateway(
            initialStatus = AuthGatewayStatus.Authenticated,
            session = anonymousSession(userId = "guest-1"),
            onRefreshSession = {
    ...
    fun linkOAuthIdentity_redirect_refreshesSession_evenWhenHydrateAloneLeavesAnonymous() =
        runUnitTest {
            ...
            runCurrent()
            repo.completeOAuthRedirect("drop2048://login-callback")
            assertIs<com.dangerfield.drop2048.libraries.identity.auth.LinkIdentityOutcome.Success>(
                link.await(),
            )
    ...
    fun signInWithOAuth_suspendsUntilRedirect_thenParsesImportsAndReturnsSuccess() = runUnitTest {
        ...
        repo.completeOAuthRedirect("drop2048://login-callback#access_token=t&refresh_token=r")
    ...
    fun completeOAuthRedirect_failure_resolvesSuspendedCall_andDoesNotThrow() = runUnitTest {
        ...
        repo.completeOAuthRedirect("drop2048://login-callback#error=access_denied")

        assertIs<com.dangerfield.drop2048.libraries.identity.auth.SignInOutcome.Cancelled>(signIn.await())
        assertIs<AuthState.Unauthenticated>(repo.current())
    }
    ...
    fun completeOAuthRedirect_noPendingHandle_coldLaunchConfirmLink_importsSession() = runUnitTest {
        ...
        val outcome = repo.completeOAuthRedirect("drop2048://login-callback#access_token=t&refresh_token=r")
    ...
    fun completeOAuthRedirect_noPendingHandle_noImportableSession_isNoOp() = runUnitTest {
        ...
        val outcome = repo.completeOAuthRedirect("drop2048://login-callback")

        assertIs<com.dangerfield.drop2048.libraries.identity.auth.SignInOutcome.Cancelled>(outcome)
        assertIs<AuthState.Unauthenticated>(repo.current())
    }
    ...
    fun completeOAuthRedirect_noPendingHandle_alreadyAuthenticated_isNoOp() = runUnitTest {
        ...
        val outcome = repo.completeOAuthRedirect("drop2048://login-callback#access_token=t")
    ...
    fun isOAuthRedirect_matchesCallbackUrl_only() = runUnitTest {
        ...
        assertTrue(repo.isOAuthRedirect("drop2048://login-callback#access_token=t"))
        assertEquals(false, repo.isOAuthRedirect("drop2048://profile"))
    }
    ...
    fun deleteAccount_noSession_returnsNotSignedIn() = runUnitTest {
        ...
        assertIs<com.dangerfield.drop2048.libraries.identity.auth.DeleteAccountOutcome.NotSignedIn>(outcome)
    }
    ...
    private fun build(
        ...
        sessionRejectionBus: com.dangerfield.drop2048.libraries.networking.SessionRejectionBus =
    ...
    private object NoOpTokenInvalidator :
        com.dangerfield.drop2048.libraries.networking.AuthTokenInvalidator {
...
internal class FakeSupabaseAuthGateway(
    ...
    override fun isOAuthRedirect(url: String): Boolean =
        url.startsWith("drop2048://login-callback")
