package com.dangerfield.drop2048.libraries.identity.auth
...
interface AuthRepository {
     ...
     * `drop2048://login-callback` and the app forwards that URL to
    ...
    /**
     * Whether [url] is the browser-OAuth redirect deep link (`drop2048://login-callback`).
     ...
     * full `drop2048://login-callback#access_token=…` callback. Imports the session
