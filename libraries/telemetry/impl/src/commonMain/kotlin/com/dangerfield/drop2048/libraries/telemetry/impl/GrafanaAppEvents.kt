...
import com.dangerfield.drop2048.libraries.storage.FileManager
 ...
 * `Drop2048BuildConfig` (see `loadTelemetryMetadata` in build-logic): CI reads
...
internal object GrafanaCloud {
    val OTLP_BASE_URL: String = Drop2048BuildConfig.GRAFANA_OTLP_BASE_URL
    val INSTANCE_ID: String = Drop2048BuildConfig.GRAFANA_OTLP_INSTANCE_ID
    val LOGS_WRITE_TOKEN: String = Drop2048BuildConfig.GRAFANA_LOGS_WRITE_TOKEN
