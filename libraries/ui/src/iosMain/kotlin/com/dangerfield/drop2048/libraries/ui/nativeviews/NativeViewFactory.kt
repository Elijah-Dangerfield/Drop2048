...
@ObjCName("Drop2048CameraGuidanceState", exact = true)
...
@OptIn(ExperimentalObjCName::class)
@ObjCName("Drop2048NativeViewFactory", exact = true)
...
@OptIn(ExperimentalObjCName::class)
@ObjCName("Drop2048NativeAppleSignInButtonKind", exact = true)
...
@OptIn(ExperimentalObjCName::class)
@ObjCName("Drop2048NativeAppleSignInButtonStyle", exact = true)
