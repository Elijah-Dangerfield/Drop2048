...
import com.dangerfield.drop2048.libraries.ui.components.dialog.ModalContent
...
private fun PreviewBasicBottomSheet() {
    PreviewContent {
        com.dangerfield.drop2048.libraries.ui.components.dialog.bottomsheet.BasicBottomSheet(
            state = rememberBottomSheetState(BottomSheetValue.Expanded),
            onDismissRequest = { -> },
            modifier = Modifier,
            stickyTopContent = { Text(text = "Top Content") },
