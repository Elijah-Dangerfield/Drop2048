 ...
 * Play Billing.
 *
 * Play Billing 8.x, because Play stopped accepting new releases on 7. The two
 * API differences that matter — `QueryProductDetailsResult` instead of a bare
 * list, and the mandatory `PendingPurchasesParams` — are both handled here.
 *
