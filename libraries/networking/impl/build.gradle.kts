...
android {
    namespace = "com.dangerfield.drop2048.libraries.networking.impl"
}
...
// local iOS dev builds — pass `-Pdrop2048.wiretap.ios=false` to link the
// zero-overhead noop instead.
//
// Store builds flip it via the DROP_2048_WIRETAP_IOS env var (set by the
...
val wiretapIosEnabled =
    (providers.environmentVariable("DROP_2048_WIRETAP_IOS").orNull
        ?: providers.gradleProperty("drop2048.wiretap.ios").orNull
        ?: "true").toBoolean()
