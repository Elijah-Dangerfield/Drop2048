package com.dangerfield.drop2048.util
...
fun Project.verifyGitHooksInstalled() {
    ...
    if (System.getProperty("drop2048.skipGitHooksCheck") == "true") return
    ...
    throw GradleException(
        ...
        -Ddrop2048.skipGitHooksCheck=true or set the CI env var.
