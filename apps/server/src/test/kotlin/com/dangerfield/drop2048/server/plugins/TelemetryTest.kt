...
import com.dangerfield.drop2048.server.config.ObservabilityConfig
...
class TelemetryTest {
    ...
    fun buildOpenTelemetrySdk_resourceCarriesServiceAndEnvAttrs() {
        ...
        assertEquals("drop2048-server", resourceAttrs.get(AttributeKey.stringKey("service.name")))
    ...
    companion object {
        ...
        private val sdk = buildOpenTelemetrySdk(
            ObservabilityConfig(
                otlpEndpoint = null,
                otlpHeaders = null,
                serviceName = "drop2048-server-test",
                environment = "test",
                release = null,
            ),
            spanExporter = exporter,
