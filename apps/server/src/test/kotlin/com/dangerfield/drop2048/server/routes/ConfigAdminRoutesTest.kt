...
class ConfigAdminRoutesTest {
    ...
    private fun testApp(
        ...
        notifier: com.dangerfield.drop2048.server.domain.ConfigChangeNotifier =
            com.dangerfield.drop2048.server.domain.ConfigChangeNotifier {},
    ...
    fun upsertFlag_notifiesOnSuccess() = runTest {
        ...
        val notifier = com.dangerfield.drop2048.server.domain.ConfigChangeNotifier { notified = it.flagPath }
