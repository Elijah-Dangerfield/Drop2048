...
final class IOSNativeViewFactory: Drop2048NativeViewFactory {
    ...
    func createAppleSignInButton(
        kind: Drop2048NativeAppleSignInButtonKind,
        style: Drop2048NativeAppleSignInButtonStyle,
        cornerRadius: Float,
        onTap: @escaping () -> Void
    ) throws -> UIView {
...
private extension Drop2048NativeAppleSignInButtonKind {
...
private extension Drop2048NativeAppleSignInButtonStyle {
