 ...
 * `drop2048.*` convention plugins: this is a `com.android.test` module that
 ...
 */
android {
    namespace = "com.dangerfield.drop2048.baselineprofile"
    compileSdk = 36
...
baselineProfile {
    // `-Pdrop2048.benchmark.useConnectedDevice=true` runs against an emulator
    ...
    val useConnected =
        providers.gradleProperty("drop2048.benchmark.useConnectedDevice").orNull == "true"
