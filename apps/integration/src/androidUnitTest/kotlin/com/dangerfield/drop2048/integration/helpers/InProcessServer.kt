...
import com.dangerfield.drop2048.server.config.DatabaseConfig
...
import com.dangerfield.drop2048.server.installApp
 ...
 * engine can't serve.
 *
 * Drop 2048 has no accounts, so there is no auth plugin here and nothing to seed.
    ...
    companion object {
        ...
        private val shared by lazy {
            val container = PostgreSQLContainer(POSTGRES_IMAGE)
                .withDatabaseName("drop2048_integration")
                .withUsername("drop2048")
                .withPassword("drop2048")
                .also { it.start() }
