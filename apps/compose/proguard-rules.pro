...
-keep,includedescriptorclasses class com.dangerfield.drop2048.**$$serializer { *; }
-keepclassmembers class com.dangerfield.drop2048.** {
    *** Companion;
    *** INSTANCE;
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keepclassmembers enum com.dangerfield.drop2048.** {
...
-keep @kotlinx.serialization.Serializable class com.dangerfield.drop2048.** { *; }
...
-keep class com.dangerfield.drop2048.libraries.navigation.** { *; }
-keep class * extends com.dangerfield.drop2048.libraries.navigation.Route { *; }
...
-keep class com.dangerfield.drop2048.**AppComponent* { *; }
